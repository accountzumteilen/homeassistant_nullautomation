...
This Home Assistant automation is a zero-export power control for a balcony solar setup. It monitors the household grid power flow and adjusts the output of a home battery (in my setup a Marstek B2500) to minimize both grid import and export. The logic behind the automation is that it works like a PI (Proportional-Integral) controller.
